...
(cl:in-package microstrain_3dmgx2_imu-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddOffset-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddOffset-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name microstrain_3dmgx2_imu-srv:<AddOffset-request> is deprecated: use microstrain_3dmgx2_imu-srv:AddOffset-request instead.")))

(cl:ensure-generic-function 'add_offset-val :lambda-list '(m))
(cl:defmethod add_offset-val ((m <AddOffset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader microstrain_3dmgx2_imu-srv:add_offset-val is deprecated.  Use microstrain_3dmgx2_imu-srv:add_offset instead.")
  (add_offset m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddOffset-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddOffset-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name microstrain_3dmgx2_imu-srv:<AddOffset-response> is deprecated: use microstrain_3dmgx2_imu-srv:AddOffset-response instead.")))

(cl:ensure-generic-function 'total_offset-val :lambda-list '(m))
(cl:defmethod total_offset-val ((m <AddOffset-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader microstrain_3dmgx2_imu-srv:total_offset-val is deprecated.  Use microstrain_3dmgx2_imu-srv:total_offset instead.")
  (total_offset m))
