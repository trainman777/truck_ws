...
echo_and_run cd "/home/odroid/truck_ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/odroid/truck_ws/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/odroid/truck_ws/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
