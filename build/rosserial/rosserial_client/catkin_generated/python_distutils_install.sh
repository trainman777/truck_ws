...
echo_and_run cd "/home/odroid/truck_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/odroid/truck_ws/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/odroid/truck_ws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
